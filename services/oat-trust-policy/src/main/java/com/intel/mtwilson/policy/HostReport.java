...
import com.intel.mtwilson.util.crypto.TpmQuote;
...
//    public Map<PcrIndex,List<Measurement>> pcrModuleManifest; // list of all modules for one pcr ... 
    ...
    public String aik; // the host's aik certificate that signed the quote (except for vmware for which we don't get an aik)
