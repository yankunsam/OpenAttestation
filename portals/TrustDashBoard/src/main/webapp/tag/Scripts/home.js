...
function getAssetCertificatePage22() {
	$('#mainContainer').html('<div id="AssetCertificatePage"></div>');
        ...
        console.log("Calling html5 Cert view");
        $('#AssetCertificatePage').html('<iframe  scrolling="no" frameborder="0" src="tag/index.html5?tab=certificates" width="100%" height="1000" > </iframe>');$('#AssetCertificatePage').html('<iframe scrolling="no" frameborder="0" src="' + assetTagUrl + "/#certificates" + '" width="900" height="850" > </iframe>');
}
