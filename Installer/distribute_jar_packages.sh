...
if test -e $JAR_SOURCE/activation.jar;then
  ...
  cp -f $JAR_SOURCE/activation.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/activation.jar
...
if test -e $JAR_SOURCE/bcprov-jdk15-141.jar;then
  ...
  cp -f $JAR_SOURCE/bcprov-jdk15-141.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/bcprov-jdk15-141.jar
...
if test -e $JAR_SOURCE/FastInfoset.jar;then
  ...
  cp -f $JAR_SOURCE/FastInfoset.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/FastInfoset.jar
...
if test -e $JAR_SOURCE/jaxb-api.jar;then
  ...
  cp -f $JAR_SOURCE/jaxb-api.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jaxb-api.jar
...
if test -e $JAR_SOURCE/jaxb-impl.jar;then
  ...
  cp -f $JAR_SOURCE/jaxb-impl.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jaxb-impl.jar
...
if test -e $JAR_SOURCE/jaxb-xjc.jar;then
  ...
  cp -f $JAR_SOURCE/jaxb-xjc.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jaxb-xjc.jar
...
if test -e $JAR_SOURCE/jaxws-api.jar;then
  ...
  cp -f $JAR_SOURCE/jaxws-api.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jaxws-api.jar
...
if test -e $JAR_SOURCE/jaxws-rt.jar;then
  ...
  cp -f $JAR_SOURCE/jaxws-rt.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jaxws-rt.jar
...
if test -e $JAR_SOURCE/jaxws-tools.jar;then
  ...
  cp -f $JAR_SOURCE/jaxws-tools.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jaxws-tools.jar
...
if test -e $JAR_SOURCE/jsr173_api.jar;then
  ...
  cp -f $JAR_SOURCE/jsr173_api.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jsr173_api.jar
...
if test -e $JAR_SOURCE/jsr181-api.jar;then
  ...
  cp -f $JAR_SOURCE/jsr181-api.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jsr181-api.jar
...
if test -e $JAR_SOURCE/jsr250-api.jar;then
  ...
  cp -f $JAR_SOURCE/jsr250-api.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/jsr250-api.jar
...
if test -e $JAR_SOURCE/mail.jar;then
  ...
  cp -f $JAR_SOURCE/mail.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/mail.jar
...
if test -e $JAR_SOURCE/mimepull.jar;then
  ...
  cp -f $JAR_SOURCE/mimepull.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/mimepull.jar
...
if test -e $JAR_SOURCE/resolver.jar;then
  ...
  cp -f $JAR_SOURCE/resolver.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/resolver.jar
...
if test -e $JAR_SOURCE/saaj-api.jar;then
  ...
  cp -f $JAR_SOURCE/saaj-api.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/saaj-api.jar
...
if test -e $JAR_SOURCE/saaj-impl.jar;then
  ...
  cp -f $JAR_SOURCE/saaj-impl.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/saaj-impl.jar
...
if test -e $JAR_SOURCE/stax-ex.jar;then
  ...
  cp -f $JAR_SOURCE/stax-ex.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/stax-ex.jar
...
if test -e $JAR_SOURCE/streambuffer.jar;then
  ...
  cp -f $JAR_SOURCE/streambuffer.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/streambuffer.jar
...
if test -e $JAR_SOURCE/woodstox.jar;then
  ...
  cp -f $JAR_SOURCE/woodstox.jar $OAT_SOURCE/OpenAttestationAdminConsole/WebContent/WEB-INF/lib/woodstox.jar
...
####### xsd #####
cp -f $JAR_SOURCE/Core_Integrity_Manifest_v1_0_1.xsd $OAT_SOURCE/HisAppraiser/xml/Integrity_Report_Manifest_v1_0/Core_Integrity_Manifest_v1_0_1.xsd
cp -f $JAR_SOURCE/Core_Integrity_Manifest_v1_0_1.xsd $OAT_SOURCE/HisClient/xml/Integrity_Report_Manifest_v1_0/Core_Integrity_Manifest_v1_0_1.xsd
cp -f $JAR_SOURCE/Integrity_Report_Manifest_v1_0.xsd $OAT_SOURCE/HisAppraiser/xml/Integrity_Report_Manifest_v1_0/Integrity_Report_Manifest_v1_0.xsd
cp -f $JAR_SOURCE/Integrity_Report_Manifest_v1_0.xsd $OAT_SOURCE/HisClient/xml/Integrity_Report_Manifest_v1_0/Integrity_Report_Manifest_v1_0.xsd
