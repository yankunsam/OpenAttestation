...
//    private UUID subjectUuid = null;
    ...
    private ArrayList<UTF8NameValueMicroformat> tags1 = new ArrayList<UTF8NameValueMicroformat>();
    private ArrayList<UTF8NameValueSequence> tags2 = new ArrayList<UTF8NameValueSequence>();
    private ArrayList<ASN1Encodable> tagsOther = new ArrayList<ASN1Encodable>();
